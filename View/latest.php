<script src="resource/javascript/latest.js" defer></script>
...
<button type="button" id="openCompareButton" class="btn btn-success bottom-right-button invisible border border-dark rounded" style="width: 50px;">
   <!-- Compare Result  -->
