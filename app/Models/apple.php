...
class apple extends Model
{
    ...
    public function getData(){
        ...
        $data['2021'] = [
            ...
            'http://api-mobilespecs.azharimm.site/v2/apple_ipad_10_2_(2021)-11106'
        ];
        $data['2020'] = [
            ...
            'http://api-mobilespecs.azharimm.site/v2/apple_ipad_pro_12_9_(2020)-10136'
        ];
        $data['2019'] = [
            ...
            'http://api-mobilespecs.azharimm.site/v2/apple_ipad_air_(2019)-9638'
        ];
        $data['2018'] = [
